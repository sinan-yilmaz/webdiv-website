...
**Porträt:** liegt als `public/portrait.jpg` vor – Porträt-Block und „Über mich“ greifen
automatisch darauf zu (fehlt die Datei, erscheint der markierte `[ Porträt folgt ]`-Platzhalter).
